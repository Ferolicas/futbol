...
export async function analyzeMatch(fixture, { date: requestDate, force } = {}) {
  ...
  const scored = modelToScored(pr.markets, { validationFamilies: pr.validationFamilies }); // frecuencia intacta + gate fuera de muestra
  ...
  // consume para selections (recommended ⊂ ≥0.90) + selectable (≥0.70 = SELECTABLE_MIN_PROB).
