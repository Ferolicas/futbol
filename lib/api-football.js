...
export async function analyzeMatch(fixture, { date: requestDate, force } = {}) {
  ...
  const { loadContextInputs, computeContext, scoreContext, persistFixtureContext, loadRuptureModels, loadFamilyModels, isKeyInjury } = await import('./context-engine');
  ...
  const scored = scoreContext(computeContext(inputs), {
    ...
    mlModels, mlEnabled, familyModels,
  });
