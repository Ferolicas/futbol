...
export async function analyzeMatch(fixture, { date: requestDate, force } = {}) {
  ...
  const combinadaResult = buildContextCombinada(scored, analysis.odds, teamNames, analysis.playerHighlights, calculatedProbabilities, analysis.cornerCardData);
  ...
  return { analysis, fromCache: false, apiCalls, persist };
}
