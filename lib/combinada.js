...
export function buildCombinada(probabilities, odds, playerHighlights, teamNames) {
  ...
  // Convierte "over11_5" o "under11_5" → 11.5 (numero) para mostrar al usuario
  ...
  // Para mercados over/under con lineas dinamicas — itera AMBOS over y under.
  // probs = { _lines, over11_5: 78, under11_5: 22, over12_5: 65, ... }
  // odds  = { Over_11_5: 1.85, Under_11_5: 1.95, Over_12_5: 2.10, ... }
  // scope/team override para per-team markets.
