...
// v21: la frecuencia cruda sigue intacta; solo se publican como opciones de
// apuesta los mercados cuya fiabilidad calculada es >=90%.
export const FOOTBALL_CACHE_VERSION = 21;
const MIN_CACHE_VERSION = FOOTBALL_CACHE_VERSION;
