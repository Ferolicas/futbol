...
const CONFIGS = {
  baseball: {
    ...
    // Triple-A: Bet365 SÍ publica cuota real para esta liga (hándicap ±1.5 y
    // una línea de total de carreras — confirmado en Bet365, no en API-Sports
    // ni The Odds API). El resto de MiLB (AA, A+, A, Rookie) sigue fuera:
    // sin verificación de que Bet365 las ofrezca, no se piden.
    competitions: [
      { id: '1', key: 'mlb', name: 'MLB', country: 'Estados Unidos', sportId: 1 },
      { id: '11', key: 'aaa', name: 'Triple-A', country: 'Estados Unidos', sportId: 11 },
    ],
    scoreLabel: 'carreras',
    periodKind: 'first5',
    lineStep: 0.5,
