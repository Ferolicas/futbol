...
export async function getSportOdds(sport, game, options = {}) {
  ...
  // MLB Stats API aporta calendario y resultados, pero no cuotas. Para MLB no
  // se vuelve a consultar API-Baseball partido a partido: si The Odds API no
  // publica Bet365 se falla cerrado y se conserva la estadística sin recomendación.
  if (config.key === 'baseball') return {
    moneyline: {}, totals: {}, spreads: {}, periods: {}, teamTotals: { home: {}, away: {} },
    statistics: { hits: { home: {}, away: {}, total: {} } }, playerProps: {}, specials: {},
    catalog: [], rawBookmakers: [], source: 'sin-cuota-bet365', providerFixtureId: null,
  };
  ...
  if (/^espn-ncaa/.test(String(game?.dataProvider || ''))) {
    return hasContractualEmbeddedOdds
      ...
      : {
        moneyline: {}, totals: {}, spreads: {}, periods: {}, teamTotals: { home: {}, away: {} },
        statistics: {}, playerProps: {}, specials: {}, catalog: [], rawBookmakers: [],
        source: 'sin-cuota-bet365', providerFixtureId: game.providerFixtureId,
      };
  }
  ...
  if (hasEmbeddedOdds && !withinApiSportsDateWindow(date)) {
    return hasContractualEmbeddedOdds
      ...
      : {
        moneyline: {}, totals: {}, spreads: {}, periods: {}, teamTotals: { home: {}, away: {} },
        statistics: {}, playerProps: {}, specials: {}, catalog: [], rawBookmakers: [],
        source: 'sin-cuota-bet365', providerFixtureId: game.espnProviderFixtureId || game.providerFixtureId,
      };
  }
  const providerFixtureId = await apiSportsFixtureIdFor(config.key, game, { ttl: options.mappingTtl });
