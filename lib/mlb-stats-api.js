...
export async function getMlbLiveGame(gamePk) {
  ...
  // apariciones al plato finalizadas: `result.type === "hit"` es el contrato
  // oficial común a sencillo, doble, triple y jonrón. Este desglose alimenta
  ...
  for (const play of allPlays) {
    ...
    if (!Number.isFinite(inning) || play?.result?.type !== 'hit') continue;
