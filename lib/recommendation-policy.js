...
// real (>=1.20, el piso de lo que Bet365 cotiza como mercado apostable) deciden
// la Apuesta del Día. `validationStatus` (calibración general entre equipos) y
// el EV quedan fuera — nunca bloquean, ni aquí ni en el catálogo general.
...
// puedan demostrar la fiabilidad exigida por el contrato vigente — la
// fiabilidad Beta-binomial de ESE enfrentamiento específico, la única que
// puede bloquear algo. `validationStatus`/`expectedValue` (calibración y
// filtros económicos generales) quedan como datos informativos: nunca vacían
// una opción real.
