...
// OJO: NO incluir "junior" — "Junior de Barranquilla" (Colombia) es un club
// ABSOLUTO, no juvenil. Las selecciones juveniles usan U##/Sub-##/Youth/Juvenil.
export const YOUTH_TEAM_RE = /\bU-?1[2-9]\b|\bU-?2[0-3]\b|\bunder[ -]?(1[2-9]|2[0-3])\b|\byouth\b|\bjuvenil\b|\bsub-?(1[2-9]|2[0-3])\b/i;
