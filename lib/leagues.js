...
export const LEAGUES = {
  ...
  // ===================== FÚTBOL FEMENINO — SELECCIONES =====================
  8:    { country: 'World',        name: 'Mundial Femenino',            division: 0, gender: 'W' },
  743:  { country: 'Europe',       name: 'Eurocopa Femenina',           division: 0, gender: 'W' },
  926:  { country: 'South America', name: 'Copa América Femenina',      division: 0, gender: 'W' },
  922:  { country: 'Africa',       name: 'Copa África Femenina',        division: 0, gender: 'W' },
  897:  { country: 'Asia',         name: 'AFC Asian Cup Femenino',      division: 0, gender: 'W' },
  1057: { country: 'North America', name: 'Copa Oro Femenina',         division: 0, gender: 'W' },
  1040: { country: 'Europe',       name: 'UEFA Nations League Femenino', division: 0, gender: 'W' },
  524:  { country: 'World',        name: 'Juegos Olímpicos Femenino',   division: 0, gender: 'W' },

  // ===================== FÚTBOL FEMENINO — CLUBES =====================
  525:  { country: 'Europe',       name: 'UEFA Champions League Femenina', division: 0, gender: 'W' },
  44:   { country: 'England',      name: 'FA WSL',                      division: 1, gender: 'W' },
  142:  { country: 'Spain',        name: 'Liga F',                      division: 1, gender: 'W' },
  82:   { country: 'Germany',      name: 'Frauen-Bundesliga',           division: 1, gender: 'W' },
  64:   { country: 'France',       name: 'Division 1 Féminine',         division: 1, gender: 'W' },
  139:  { country: 'Italy',        name: 'Serie A Femenile',            division: 1, gender: 'W' },
  673:  { country: 'Mexico',       name: 'Liga MX Femenil',             division: 1, gender: 'W' },
  74:   { country: 'Brazil',       name: 'Brasileirão Feminino',        division: 1, gender: 'W' },
  712:  { country: 'Colombia',     name: 'Liga Femenina',               division: 1, gender: 'W' },
};

export const ALL_LEAGUE_IDS = Object.keys(LEAGUES).map(Number);

// Identificación de equipos JUVENILES por nombre. API-Football NO expone un
// campo de categoría sub/juvenil (solo `national:true/false`), así que el
// nombre es la única señal: "Ghana U20", "Mexico U23", "Spain Sub-21",
// "Argentina U-17", "X Youth/Junior/Juvenil". Cubre U12–U23, under-XX y sub-XX.
// Se usa para excluir juveniles de Amistosos (liga 10) y de cualquier sitio,
// dejando solo selecciones ABSOLUTAS. Mismo patrón que el filtro de ligas.
// OJO con falsos positivos de CLUBES absolutos:
//  - "junior" NO se incluye ("Junior de Barranquilla" / "Atlético Junior").
//  - "youth"/"juvenil" SOLO al FINAL del nombre ("England Youth" = selección)
//    para no cazar clubes con la palabra en medio ("Qingdao Youth Island", CHN).
// Los U##/Sub-##/under-## son inequívocamente juveniles en cualquier posición.
export const YOUTH_TEAM_RE = /\bU-?1[2-9]\b|\bU-?2[0-3]\b|\bunder[ -]?(1[2-9]|2[0-3])\b|\bsub-?(1[2-9]|2[0-3])\b|\b(youth|juvenil)\s*$/i;
export function isYouthTeam(name) {
  return YOUTH_TEAM_RE.test(String(name || ''));
}
