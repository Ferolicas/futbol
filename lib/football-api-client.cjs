...
// No existe reserva preventiva de cuota diaria. Todas las rutas pueden consumir
// hasta la última llamada contractual. `priority` solo permite que fixtures,
// live y results sondeen antes la recuperación DESPUÉS de un agotamiento real.
