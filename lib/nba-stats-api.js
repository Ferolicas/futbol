...
export async function getBasketballGamesByDate(date, options = {}) {
  ...
  // En los planes gratuitos las dos APIs de respaldo solo admiten una ventana
  // móvil de tres días. Fuera de ella multisport-providers usa el calendario
  // amplio gratuito, sin consumir llamadas destinadas a cuotas y boxscores.
  if (!withinApiSportsDateWindow(date)) return [];
