...
// Dos gates alineados con el spec:
//   selectable = mercados que el usuario puede AÑADIR a su combinada manual
//                (≥70% prob + cuota ≥1.20). Acordeón del frontend.
//   selections = sub-conjunto destacado para la "Apuesta del Día"
//                (≥90% prob + cuota ≥1.20). Lo que se chip-resumen en la card.
// MIN_ODD = 1.20 garantiza que apuestas combinadas tengan rendimiento mínimo.
const BASEBALL_SELECTABLE_THRESHOLD = 70;
const BASEBALL_SELECTIONS_THRESHOLD = 90;
...
export function buildBaseballCombinada(probabilities, bestOdds, teamNames = {}) {
  ...
  //   selections = subconjunto ≥90% para "Apuesta del Día"
  ...
  // (Apuesta del Día); si está vacía, sobre `selectable` (fallback útil para
  // el chip resumen). hasRealOdds aplica al conjunto que se está reportando.
