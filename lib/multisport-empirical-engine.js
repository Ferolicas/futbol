...
function probabilityComplement(entry) {
  ...
  return { probability: displayPercent(rawProbability), rawProbability, evidence: entry.evidence };
}
...
function buildBaseballPeriodPrediction(homeRows, awayRows, key, odds, currentShare) {
  ...
  return {
    ...
    expected: {
      home: empiricalMean(homeScore, currentShare),
      away: empiricalMean(awayScore, currentShare),
      total: empiricalMean(totalRows, currentShare),
    },
    samples: {
