...
export async function createOrder({ plan, formData, userId, backUrl, ipAddress }) {
  ...
  const body = {
    ...
    payer: {
      ...
      // PSE exige (desde 2025) teléfono y dirección completa CON departamento
      // (federal_unit). El Payment Brick no los recoge → defaults de Colombia
      // (son formalismo: la transferencia la autoriza el banco).
      phone: payer.phone || { area_code: '601', number: '0000000' },
      address: payer.address || {
        zip_code: '110111', street_name: 'N/A', street_number: 'S/N',
        neighborhood: 'Centro', city: 'Bogota', federal_unit: 'DC',
      },
    },
  };
