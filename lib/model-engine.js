...
function modulateH2H(markets, rows, mode) {
  const H = rows;                 // perspectiva del local de hoy
  ...
  modBool(markets.clean_sheet_home, H, (r) => r.clean_sheet, mode);
  modBool(markets.clean_sheet_away, F, (r) => r.clean_sheet, mode);
  mod1x2(markets['1x2'], H, mode);
}
