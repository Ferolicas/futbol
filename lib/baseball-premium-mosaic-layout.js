export const BASEBALL_MOSAIC_LOGICAL_WIDTH = 2560;
export const BASEBALL_MOSAIC_LOGICAL_HEIGHT = 1440;
export const BASEBALL_MOSAIC_WIDTH = 3840;
export const BASEBALL_MOSAIC_HEIGHT = 2160;
