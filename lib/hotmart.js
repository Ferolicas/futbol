...
// Checkout REAL (no la página de ventas go.hotmart.com). checkoutMode=2 + el
// widget (widget.min.js + clase hotmart-fb) abren el pago en un popup/modal
// SOBRE cfanalisis.com, sin sacar al usuario de la web.
