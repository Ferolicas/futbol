...
- Free se filtra en servidor: una opción 60–70%, independiente de fiabilidad, solo con cuota real >=1.20 y casa identificada; esa opción visible se puede añadir a la combinada. Antes del cierre, de las bloqueadas solo viaja la probabilidad y nunca sus etiquetas/IDs; después del final oficial se revelan nombre, cuota, casa y resultado.
